...
**Kaufpreis + Nebenkosten** berücksichtigen:

```
Beispielrechnung für € 20.000 Auto:
├── Kaufpreis: € 20.000
├── Zulassung: € 150-300
├── Versicherung (Jahr): € 800-1.200
├── Steuern (Jahr): € 400-800
├── Service/Wartung: € 500-1.000
└── Unvorhergesehenes: € 500
───────────────────────────
Gesamtkosten Jahr 1: € 22.350-23.800
```

💡 **Faustregel**: Rechnen Sie 10-15% Nebenkosten zum Kaufpreis.
...
- Wie viel Kofferraumvolumen?
- Anhängerlast erforderlich?
...
| -------------- | -------------------------------------------------- | ------------------------------------ |
| **Barzahlung** | Verhandlungsspielraum<br>Keine Zinsen              | Großer Kapitaleinsatz                |
| **Kredit**     | Liquidität bleibt erhalten<br>Planbare Raten       | Zinskosten<br>Bonität erforderlich   |
| **Leasing**    | Niedrige Monatsraten<br>Neues Auto alle paar Jahre | Kein Eigentum<br>Kilometerbegrenzung |
...
**Top-Zuverlässigkeit** (ÖAMTC-Statistik):

1. **Toyota**: Corolla, RAV4, Yaris
2. **Honda**: Civic, CR-V
3. **Mazda**: CX-5, Mazda 6
4. **Škoda**: Octavia, Superb
5. **VW**: Golf, Passat

**Deutsche Premium-Marken**:

- BMW, Mercedes, Audi: Hochwertig, aber teurer in Wartung
- Tipp: Jüngere Gebrauchte mit Garantie

## Die Besichtigung: Ihre Checkliste
...
- Taschenlampe
- Reifenprofilmesser
- Magnet (für Spachtelmasse-Test)
- OBD2-Scanner (optional, aber empfohlen!)

### Außencheck (bei Tageslicht!)
...
- Verschiedene Farbtöne (Unfallschaden?)

✅ **Magnet-Test**:

- Karosserie sollte magnetisch sein
- Spachtelmasse ist nicht magnetisch
- Test an allen Panelen!

#### Reifen & Räder

```
✓ Profiltiefe mindestens 3 mm (besser 5+ mm)
✓ Alle 4 Reifen vom gleichen Hersteller
✓ Produktionsjahr max. 6 Jahre alt (DOT-Nummer)
✓ Keine Risse, Beulen oder ungleichen Abrieb
✓ Felgen ohne Kratzer/Beschädigungen
```

#### Lichter & Verglasung

- Alle Lichter funktionstüchtig?
- Scheiben ohne Steinschläge/Risse?
- Scheinwerfer klar oder blind/milchig?
...
- Gepflegter Zustand
- Keine starken Gerüche (Rauch, Schimmel)
- Abnutzung passt zu Laufleistung

❌ **Warnsignale**:

- Stark abgenutzte Pedale bei niedriger Laufleistung
- Wasserflecken unter Teppichen
- Muffelgeruch (Wasserschaden!)
...
- [ ] Klimaanlage kühlt
- [ ] Heizung wärmt
- [ ] Radio/Navi funktioniert
- [ ] Elektrische Fensterheber
- [ ] Zentralverriegelung
- [ ] Sitzverstellung
- [ ] Airbag-Warnleuchte erlischt
- [ ] Tempomat
- [ ] Einparkhilfe/Kamera
...
✅ Sauber und trocken
✅ Keine Öl- oder Kühlwasser-Lecks
✅ Kabel und Schläuche intakt
✅ Ölstand korrekt (Peilstab!)
✅ Kühlwasser ausreichend

❌ **Warnsignale**:

- Öliger, schmutziger Motorraum
- Frische Reinigung (etwas verbergen?)
- Undichte Stellen
...
1. **Kaltstart durchführen**
   ...
   - Motor sollte sofort anspringen
   - Keine ungewöhnlichen Geräusche
   - Kein übermäßiger Rauch

2. **Armaturenbrett beobachten**
   - Alle Warnleuchten kurz aufleuchten
   - Dann erlöschen (außer normalen Anzeigen)
   - Öldruckwarnleuchte muss erlöschen!

### Während der Fahrt (mind. 30 Min!)

**Test-Route planen**:

- Stadt (Stop & Go, niedrige Geschwindigkeit)
- Landstraße (Beschleunigung, Handling)
- Autobahn (Höchstgeschwindigkeit, Geräusche)

#### Motor & Getriebe

✅ **Gut**:

- Samtiges Schaltgefühl
- Kein Rutschen der Kupplung
- Gleichmäßiger Lauf
- Saubere Beschleunigung
...
- Kupplung schleift
- Klappern, Pfeifen, Quietschen

#### Fahrwerk & Lenkung

```
Testprogramm:
1. Über Bodenwellen fahren (klappert es?)
2. Volleinschlag links/rechts (knacksen?)
3. Starkes Bremsen (zieht es zur Seite?)
4. Lenkrad loslassen (fährt geradeaus?)
```
...
- ESP (wird aktiviert bei Bedarf?)
- ABS (bei Bremsung fühlbar?)
- Tempomat/ACC
- Spurhalteassistent
- Einparkhilfe
...
- Name des Verkäufers stimmt mit Ausweis überein?
- Keine Einträge von Finanzierungen/Sicherheiten

📄 **Zulassungsbescheinigung Teil I** (Fahrzeugschein)

- Daten stimmen mit Fahrzeug überein
- Keine Manipulationsspuren

📄 **Service-Heft/Historie**

- Lückenlose Wartungshistorie
- Stempel von autorisierten Werkstätten
- Regelmäßige Inspektionen

### Zusatz-Dokumente (nice to have)

✅ Rechnungen für Reparaturen  
✅ TÜV/§57a-Gutachten  
✅ Kaufvertrag vom Vorbesitzer  
✅ Reifen-/Räder-Rechnungen

## Der Gebrauchtwagen-Check

### Profi-Inspektion empfohlen!

**Kosten**: € 100-200  
**Dauer**: 1-2 Stunden  
**Wo**: ÖAMTC, ARBÖ, Dekra, oder Werkstätten
...
💰 **Lohnt sich immer** – deckt versteckte Mängel auf!
...
- Manipulations-Hinweise

**Kosten**: € 20-50 oder eigenes Gerät (ab € 15)
...
1. Interesse zeigen, aber nicht übertrieben
2. Mängel sachlich ansprechen
3. Reparaturkosten erwähnen
4. Gegenvorschlag machen
5. Kompromiss finden

💡 **Tipp**: Bei Händlern ist mehr Spielraum als bei Privat!

## Der Kaufvertrag

### Privatverkauf

- [Musterkaufvertrag ÖAMTC](https://www.oeamtc.at/thema/vorschriften-strafen/musterkaufvertrag-fuer-den-gebrauchtwagenkauf-16165335) verwenden
- Beide Parteien unterschreiben
- Je ein Exemplar für Käufer und Verkäufer

**Wichtige Klauseln**:

- "Gekauft wie besichtigt" (üblich bei Privat)
...
- **24 Monate Gewährleistung** (bei Neuwagen)
- **12 Monate** bei Gebrauchtwagen (Fahrzeuge über 3 Jahre)
- Innerhalb 6 Monate: Beweislastumkehr

⚠️ **Vorsicht bei**:

- "Verkauf unter Ausschluss jeglicher Gewährleistung"
- Bei Händlerkauf oft unwirksam!

## Nach dem Kauf

### Sofort-Checklist

- [ ] Ummeldung binnen 10 Tagen (Österreich)
- [ ] Versicherung abschließen
- [ ] Alten Halter abmelden lassen
- [ ] Kaufvertrag sicher aufbewahren
- [ ] Service-Termin vereinbaren

### Erste Inspektion

Auch wenn gerade Service gemacht:

- Ölwechsel zur Sicherheit
...
- Unrealistisch niedrige Laufleistung
- Abnutzung passt nicht zur Km-Angabe
- Keine lückenlose Historie

✅ **Schutz**:

- Carfax/AutoDNA-Report anfordern
- Alle Service-Rechnungen prüfen
- Profi-Check beim ÖAMTC
...
- Ungleiche Spaltmaße
- Überlackierungen
- Schweißnähte an unüblichen Stellen
...
### 3. Motor-/Getriebeschaden

❌ **Warnsignale**:

- Ölverlust
- Unrunde Laufleistung
- Rauchentwicklung
...
📥 [Gebrauchtwagen-Checkliste PDF](../assets/downloads/gebrauchtwagen-checkliste.pdf)  
Drucken Sie unsere Checkliste aus und nehmen Sie sie zur Besichtigung mit!
...
- [E-Mobilität in Kärnten](elektromobilitaet.html)
